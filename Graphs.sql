...
DEFINE EN = 'Izhevsk';
WITH SRC AS (
    SELECT 'Moscow' SR, 'Kazan' DEST, 2000 RAST FROM DUAL
    UNION ALL
    SELECT 'Moscow', 'Saint-Petersburg', 200 FROM DUAL
    UNION ALL
    SELECT 'Moscow', 'Belgorod', 800 FROM DUAL
    UNION ALL
    SELECT 'Kazan', 'Saint-Petersburg', 700 FROM DUAL
    UNION ALL
    SELECT 'Saint-Petersburg', 'Izhevsk', 735 FROM DUAL
    UNION ALL
    SELECT 'Saint-Petersburg', 'Moscow', 400 FROM DUAL
    UNION ALL
    SELECT 'Izhevsk', 'Moscow', 5000 FROM DUAL
),
TOWNS AS (
